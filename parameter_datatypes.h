...
typedef enum
	...
	STORAGE_HANDLE_MIXER = 4,
	STORAGE_HANDLE_RTL_SETTINGS = 5,
	STORAGE_HANDLE_WAYPOINTS = 6,
	STORAGE_HANDLE_CONTROL_GAINS = 7,
	STORAGE_HANDLE_THROTTLE_HEIGHT_OPTIONS = 8,
	STORAGE_HANDLE_AIRSPEED_OPTIONS = 9,
