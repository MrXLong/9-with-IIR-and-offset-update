...
//    QUAD             RST Quadrokopter
//    BOXCOPTER        RST Boxcopter switch -- (no RC, no motors) mode
// (Note that although AIRFRAME_HELI is also recognized, the code for this airframe type is not ready.)
#define AIRFRAME_TYPE                      QUAD
...
#define FAILSAFE_INPUT_MAX                  9500
...
#define COMPANION_ID                        99           //component value for raspberry pi


#define VOLTAGE_SENSOR_OFFSET               0       // Add 0.0 Volts to whatever value we sense
#define VOLTAGE_RATIO                       5.584   // Ratio between value we see and approximate battery voltage
//Values for battery monitor
//2.607 = 14.56 -> 5.585
//2.144 = 11.97 -> 5.583
//LOWEST SAFE MIN
//2.176 = 12.15 -> 5.584

#define LIPO_CELL_MAX       4.2    //NORMAL SAFE MAX FOR LIPO CELL - NORMALLY SHOULDNT CHANGE THIS
#define LIPO_CELL_MIN       3.0    //NORMAL SAFE MIN FOR LIPO CELL - NORMALLY SHOULDNT CHANGE THIS
#define NUM_LIPO_CELLS      4      //Currently using 4S battery pack
#define LOW_VOLTAGE_ALARM   12.4    //Voltage at which to trigger low voltage alarm (currently, just a flashing LED)
...
// times projection of the desired earth vertical rotation rate onto that axisok
...
//PERTAINS TO RST QUAD
//MW THESE ARE THE PID GAINS.
//CURRENTLY, ROLL,PITCH,YAW GAINS ARE NOT READ FROM THIS FILE, BUT SHOULD BE
...
//Yaw/Rudder Control gains
#define YAWKP                      1.00
#define YAWKI                      0.00
#define YAWKD                      0.00

//Hover/Height/Altitude Control gains
#define HOVERKP                    4.00    //high value because cm to pwm
#define HOVERKI                    2.00 
#define HOVERKD                    0.00

#define NOMINAL_HVR_THR_VAL        7000    //nominal pwm value for hovering         
//END PERTAINS TO RST QUAD
...
//frequency at which autopilot control loops are called, given in Hz
#define AUTOPILOT_FREQ      5

//minimum possible throttle value before being considered grounded, and PID values are reset
#define MIN_THROTTLE_VALUE  5900
#define MAX_THROTTLE_VALUE  9500