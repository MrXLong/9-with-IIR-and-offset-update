...
#include "libq.h"       //required here for _Q16 definition
...
#define GyroConstant        0.0625       // processedGyro * GyroConstant     = [degrees/sec (º/s)]
...
#define EulerConstant       0.010986328393221  // eulerAngle * EulerConstant       = [Degrees (º)]
...
//#define offset_roll_angle   300//105
//#define offset_pitch_angle  364.9
//#define offset_yaw_rate     0.0

//extern int offset_roll_angle;
//extern int offset_pitch_angle;
extern float offset_yaw_angle;
extern int offset_roll_rate;
extern int offset_pitch_rate;
extern int offset_yaw_rate;
...
typedef struct UM7Data{ // Struct to safe and use the sensor data from UM7
    float processedGyroX; //0x5C
    float processedGyroY; //0x5C
    float processedGyroZ; //0x5D
    float processedAcc_X; //0x5E
    float processedAcc_Y; //0x5E
    float processedAcc_Z; //0x5F
    float processedMagX;  //0x60
    float processedMagY;  //0x60
    float processedMagZ;  //0x61
    
    int eulerRollAngle; //0x70 (phi)
    int eulerPitchAngle;//0x70 (theta)
    int eulerYawAngle;  //0x71 (psi)
    int eulerRollRate;  //0x72
    int eulerPitchRate; //0x72
...
extern volatile int box_copter;
/****************************************************************************
